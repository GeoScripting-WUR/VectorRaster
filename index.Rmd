...
The functions of the *sp* package work together with functions in *rgdal*, *rgeos* and *raster* package to format changes, geometry selections or transformations and raster/vector format changes.
