...
In the previous lessons we saw how to deal with [raster](http://geoscripting-wur.github.io/IntroToRaster/) data using R. This lesson is an introduction on how to handle vector data in R, as well as how to handle the combination of vector and raster data in R.
