...
dataDir <- 'data/'
ls8zip <- paste0(dataDir,"landsat8.zip")
...
download.file(url = 'https://raw.githubusercontent.com/GeoScripting-WUR/VectorRaster/gh-pages/data/landsat8.zip', destfile = ls8zip, method = 'auto')
unzip(ls8zip, exdir = dataDir)

## Identify the right file
landsatPath <- list.files(path = dataDir, pattern = glob2rx('LC8*.grd'), full.names = TRUE)
