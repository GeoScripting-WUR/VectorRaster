...
plot(bel)
line <- drawLine() # click the start and end locations on the plot and press escape to finish line
```
...
- Made a true greatCircle line using `greatCircle()` from the and extracted the elevation values from it.
